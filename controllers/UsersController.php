...
class UsersController extends BaseController
{
    ...
    function view($username) {
        //if the user doesn't exists redirect to current user profile page
    ...
    function edit($userId) {
        ...
        if ($this->isPost) {
            ...
            if ($this->formValid()) {
                ...
                $isEdited = $this->model->editUser($userId, $password_hash, $email, $first_name, $last_name, $profile_pic_path);
                ...
                if ($isEdited) {
                    ...
                    header('Location: ' . APP_ROOT ."/users/edit/" . $userId);
                } else {
