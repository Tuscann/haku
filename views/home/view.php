    ...
    hidden; visibility: hidden;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden;">
            <div data-p="225.00" style="display: none;">
                <img src="<?= APP_ROOT?>/content/images/pic1.jpg" />
            ...
            <div data-p="225.00" style="display: none;">
                <img src="<?= APP_ROOT?>/content/images/pic2.jpg" />
            </div>
            <div data-p="225.00" style="display: none;">
                <img data-u="image" src="<?= APP_ROOT?>/content/images/pic3.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
...
<section id="one">
    ...
    <div class="container">
        ...
        <img src="<?= APP_ROOT ?>/content/images/Witcher3.jpg"
    </div>
</section>
